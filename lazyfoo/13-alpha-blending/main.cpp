...
int main( int argc, char* args[] )
{
    ...
    modulated_texture.load_from_file("./fadeout.png");
    // set standard alpha blending
    modulated_texture.set_blend_mode(SDL_BLENDMODE_BLEND);

    // since the background is not going to be transparent
    // we dont need to set a blend mode on it
    background_texture.load_from_file("./fadein.png");
